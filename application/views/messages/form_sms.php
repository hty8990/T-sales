...
<?php echo form_open("messages/send_form/".$person_info->person_id, array('id'=>'send_sms_form', 'class'=>'form-horizontal')); ?>
	<fieldset>
		<div class="form-group form-group-sm">
			<?php echo form_label($this->lang->line('messages_first_name'), 'first_name_label', array('for'=>'full_name', 'class'=>'control-label col-xs-2')); ?>
			<div class="col-xs-10">
				<?php echo form_input(array('class'=>'form-control input-sm', 'type'=>'text', 'name'=>'full_name', 'value'=>$person_info->full_name, 'readonly'=>'true'));?>
			</div>
		</div>
		<div class="form-group form-group-sm">
