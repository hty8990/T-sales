...
<?php 
if(isset($thu_chi[0]['receiving_time']) && $thu_chi[0]['receiving_time'] !== ''){
$start_date = date("d/m/Y", strtotime($thu_chi[0]['receiving_time']));
}else{
...
?>
<?php echo form_open('config/savesochi/'.$thu_chi[0]['thu_chi_id'], array('id'=>'item_kit_form', 'class'=>'form-horizontal')); ?>
