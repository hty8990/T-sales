...
<?php echo form_open('items/save_quantities/'.$item_info->id, array('id'=>'item_form_quantitie', 'enctype'=>'multipart/form-data', 'class'=>'form-horizontal')); ?>
	<fieldset id="inv_item_basic_info">
		...
		<div class="form-group form-group-sm">
			<?php echo form_label($this->lang->line('items_unit_weigh'), 'unit_weigh', array('class'=>'control-label col-xs-3')); ?>
			<div class='col-xs-8'>
				<?php echo form_dropdown('unit_weigh', $quycach, $item_info->unit_weigh, array('class'=>'form-control','disabled'=>'')); ?>
			</div>
		</div>
		<div class="form-group form-group-sm">
		...
		<div class="form-group form-group-sm">
			...
			<div class='col-xs-3'>
				...
				<?php echo form_input(array(
						...
						<span class="input-group-addon input-sm">Bao</span>
				</div>
			</div>
		</div>
		<div class="form-group form-group-sm">
...
<script type="text/javascript">
	...
	$(document).ready(function()
	{
		...
		$('#item_form_quantitie').validate($.extend({
