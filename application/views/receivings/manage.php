...
<div id="title_bar" class="print_hide btn-toolbar">
	...
	<?php echo anchor("receivings", '<span class="glyphicon glyphicon-shopping-cart">&nbsp</span>' . $this->lang->line('receivings_register'), array('class'=>'btn btn-info btn-sm pull-right', 'id'=>'show_sales_button')); ?>
</div>
