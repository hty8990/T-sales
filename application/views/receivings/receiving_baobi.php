...
<table class="sales_table_100" id="register">
		<colgroup>
			<col width="3%"><col width="8%"><col width="40%"><col width="8%"><col width="12%"><col width="8%"><col width="15%">
		</colgroup>
		<thead>
			<tr>
				<th  style="border-right: 1px solid white;"><?php echo $this->lang->line('common_delete'); ?></th>
				<th  style="border-right: 1px solid white;"><?php echo $this->lang->line('sales_item_number'); ?></th>
				<th style="border-right: 1px solid white;"><?php echo $this->lang->line('sales_item_name'); ?></th>
				<th  style="border-right: 1px solid white;">Loại</th>
				<th  style="border-right: 0.5px solid white;border-bottom : 1px solid white">Số lượng</th>
				<th  style="border-right: 1px solid white;">Giá nhập</th>
				<th   style="border-right: 0.5px solid white;border-bottom : 1px solid white">Thành tiền</th>
			</tr>
		</thead>
			...
			?>
					<?php echo form_open($controller_name."/edit_item/$line", array('class'=>'form-horizontal', 'id'=>'cart_'.$line)); ?>
							...
							<td style="text-align: left;">
								<?php echo $item['name']; ?><br /> <?php echo '[' . to_quantity_decimals($item['quantity_in_stock']) . ' túi trong kho ]'; ?>
							</td>
							<td><?php echo $item['unit_weigh']. " kg"; ?></td>
							<?php $id= 'idcount'.$i ?>
...
vertical-align: middle;"><td colspan="3">Tổng</td>
					<!-- Tinh so luong -->
					<td></td>
					<td><?php echo $soluong ?></td><td></td>
					<td><?php echo to_currency($total) ?></td></tr>
					<?php }
			}
			?>
		</tbody>
						...
						<div class="form-group form-group-sm">
							...
							<table class="sales_table_100" id="payment_details">
								<tr>
									...
									<td>
										<?php echo form_input(array('name'=>'amount_tendered', 'value'=>$amount_tendered, 'class'=>'form-control input-sm', 'size'=>'5')); ?>
									</td>
								</tr>
							</table>
