	...
	<table class="sales_table_100" id="register">
		...
		<thead>
			<tr>
				...
				<th colspan="2" style="border-right: 0.5px solid white;border-bottom : 1px solid white">Số lượng trả</th>
					...
					<?php echo form_open($controller_name."/edit_item/$line", array('class'=>'form-horizontal', 'id'=>'cart_'.$line)); ?>
						<tr>
							...
							<td>
								...
								$price = $item['price'];
								?>
								<?php echo form_input(array('id' => ''.$id.'2'.'','name'=>'price', 'class'=>'form-control input-sm', 'value'=>to_currency_no_money($price), 'tabindex'=>++$tabindex));?>
