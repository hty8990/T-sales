...
<div id="page_title"><span style="font-weight: bold; font-size: 25px; margin-left: 10px;color: #217DBB; font-family: "Times New Roman",serif;">Báo cáo công nợ phải trả</span></div>
...
<input style="display: none" id="type" value="congnotra">
<?php echo form_open('#', array('id'=>'item_form', 'enctype'=>'multipart/form-data', 'class'=>'form-horizontal')); ?>
	...
	<div class="form-group form-group-sm" style="margin-left: 5%;">
		<?php echo form_label("Nhà cung cấp", 'report_date_range_label', array('class'=>'control-label col-xs-3')); ?>
		<div class="col-xs-4">
