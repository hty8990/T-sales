...
<div id="page_title"><span style="font-weight: bold; font-size: 25px; margin-left: 10px;color: #217DBB; font-family: "Times New Roman",serif;">Báo cáo công nợ phải thu</span></div>
...
<input style="display: none" id="type" value="congnothu">
