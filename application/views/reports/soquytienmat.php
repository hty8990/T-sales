...
<div id="page_title"><span style="font-weight: bold; font-size: 25px; margin-left: 10px;color: #217DBB; font-family: "Times New Roman",serif;">Báo cáo Sổ quỹ tiền mặt</span></div>
...
<input style="display: none" id="type" name="type" value="soquytienmat">
<?php echo form_open('#', array('id'=>'item_form', 'enctype'=>'multipart/form-data', 'class'=>'form-horizontal')); ?>
	...
	<div class="form-group form-group-sm" style="margin-left: 5%;">
			...
			<div class='col-xs-4'>
				<?php echo form_dropdown('payment_type', $payment_options,"", array('id'=>'payment_type', 'class'=>'form-control')); ?>
			</div>
		</div>
	<div class="form-group form-group-sm" style="margin-left: 5%;">
			<?php echo form_label('Đối tượng', 'sales_payment', array('class'=>'control-label col-xs-3')); ?>
			<div class='col-xs-4'>
				<?php echo form_dropdown('khachhang_type', $arrKhachhang,"", array('id'=>'khachhang_type', 'class'=>'form-control')); ?>
			</div>
		</div>
	<!--<div class="form-group form-group-sm" style="margin-left: 5%;">
		<?php echo form_label("Tìm mã khách hàng", 'report_date_range_label', array('class'=>'control-label col-xs-3 required')); ?>
		<div class="col-xs-4">
...
$(document).ready(function()
{
	...
	$("#khachhang_type").change(function() {
	  table_support.refresh();
	});
	...
	table_support.init({
		...
		queryParams: function() {
			return $.extend(arguments[0], {
				...
				khachhang_type: $("#khachhang_type").val(),
				type: $("#type").val(),
				filters: $("#filters").val() || [""]
			});
		}
