...
<div id="page_title"><span style="font-weight: bold; font-size: 25px; margin-left: 10px;color: #217DBB; font-family: "Times New Roman",serif;">Báo cáo doanh số khách hàng</span></div>
...
<input style="display: none" id="type" value="doanhsokhachhang">
